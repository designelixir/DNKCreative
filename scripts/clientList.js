var clientList = [
    {
        name: 'Aveda',
        description: `Led the conceptualization and filming of all lo-fi and behind-the-scenes content for Aveda's Holiday 2023 Kit campaign and Aveda Congress. DNK Creative also spearheaded the Before/After photoshoot for two of the brand’s major franchises, contributing to creative direction on set. In addition, DNK collaborated closely with the internal team to manage the 'Real-Time' social media account, identifying and executing timely social media trends.`,
        services: ['Content Planning', 'Content Creation', 'User Generated Content'],
    ...
    },
    {
        ...
        services: ['Social Media Management', 'Content Planning', 'Content Creation' ],
    ...
    },
    {
        ...
        services: ['Influencer Relations', 'Content Planning' ],
    ...
    },
    {
        ...
        services: ['Social Media Strategy', 'Social Media Management', 'Content Planning', 'Content Creation',  'Influencer Relations', 'User Generated Content'],
    ...
    },
    {
        ...
        services: ['Social Media Management', 'Content Creation', 'User Generated Content'],
    ...
    },
    {
        ...
        services: ['Social Media Strategy', 'Social Media Management', 'Content Planning', 'Content Creation' ],
